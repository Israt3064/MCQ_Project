...
public int tracker;
    ...
    public AddNewQuestion2(String who , int tracker) {
        initComponents();
        teacher = who;
        try{
            ...
            int count = 1;
            ResultSet rs = st.executeQuery("SELECT COUNT(*) AS counter FROM israt");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            Connection con = ConnectionProvider.getCon();
            String k = "INSERT INTO israt VALUES(?,?,?,?,?,?,?)";
            ...
            setVisible(false);
            new AddNewQuestion2(teacher , tracker).setVisible(true);
