...
public int tracker;    
    ...
    public AddNewQuestion(String who , int tracker) {
        initComponents();
        teacher = who;
        tracker = tracker;
        try{
            ...
            int count = 1;
            ResultSet rs = st.executeQuery("SELECT COUNT(*) AS counter FROM ems");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            Connection con = ConnectionProvider.getCon();
            String k = "INSERT INTO ems VALUES(?,?,?,?,?,?,?)";
            ...
            setVisible(false);
            new AddNewQuestion(teacher , tracker).setVisible(true);
