...
public int tracker; 
    ...
    public AddNewQuestion1() {
     ...
     public AddNewQuestion1(String who , int track) {
        initComponents();
        teacher = who;
        tracker = track;
        ...
        try{
            ...
            int count = 1;
            ResultSet rs = st.executeQuery("SELECT COUNT(*) AS counter FROM tonoy");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            Connection con = ConnectionProvider.getCon();
            String k = "INSERT INTO tonoy VALUES(?,?,?,?,?,?,?)";
            ...
            setVisible(false);
            new AddNewQuestion1(teacher,tracker).setVisible(true);
